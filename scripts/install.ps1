...
$RepoUrlSsh = "git@github.com:grchylay/HermesAgent.git"
$RepoUrlHttps = "https://github.com/grchylay/HermesAgent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/grchylay/HermesAgent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/grchylay/HermesAgent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/grchylay/HermesAgent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
